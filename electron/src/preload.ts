...
contextBridge.exposeInMainWorld('electron', {
  ...
  invoke: (channel: string, ...args: unknown[]) => {
    const validChannels = [
      ...
      // V3.0.0: SQLite IPC channels
      'sqlite:isAvailable',
      'sqlite:init',
      'sqlite:close',
      'sqlite:episodes:list',
      ...
      'sqlite:relations:create',
      'sqlite:graph:traverse',
      'sqlite:profile:get',
      'sqlite:profile:update',
      'sqlite:skills:list',
      'sqlite:skills:create',
      'sqlite:hooks:list',
      'sqlite:hooks:create',
      'sqlite:search:fts5',
      'sqlite:raw:query',
      // V3.0.0: Whisper.cpp sidecar IPC channels
      'whisper:status',
      'whisper:start',
      'whisper:stop',
      'whisper:transcribe',
